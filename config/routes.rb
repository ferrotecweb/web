ActionController::Routing::Routes.draw do |map|
  ...
  map.main '', :controller => "ferrotec", :action=>'index'
  map.signin 'dahe', :controller => 'dahe', :action => 'index'
  map.signin 'shenhe', :controller => 'shenhe', :action => 'index'
  map.signin 'hanhong', :controller => 'hanhong', :action => 'index'
