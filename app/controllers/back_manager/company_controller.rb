class BackManager::CompanyController < ApplicationController
  ...
  def list_company
    @all_companys = Company.find(:all)
  end

  def delete_company
    if request.post?
      #已应用的公司不允许删除
      @company = Category.find(:all,
